...
<header>
    <div class="container-fluid">
        <div class="">
            <div class="row  ">
                <a class="col-md-2 col-small mx-2 main-service text-center single_box" href="{{route('room')}}">
                    ...
                    <div class=" col-12 search_form_sec d-none">
                        <div class="row  justify-content-between">
                            <div class="col-12 top-from">
                                <input type="text" name="filter[address]" class="form-control" id="room_search_autocomplete" placeholder="Location" aria-label=" location">
                            </div>
                            <div class="col-lg-4 col-md-4 mt-2  top-from">
                        ...
                        <div class="my-4 ps-2">
                            ...
                            <div class="form-check form-check-inline mx-3 pt-2">
                                ...
                                <label class="form-check-label checkboxes-label" for="furnished">Furniture</label>
                            </div>
                            <div class="form-check form-check-inline mx-3 pt-2">
                            ...
                            <div class="form-check form-check-inline mx-3 pt-2">
                                <input class="form-check-input" type="checkbox" name="filter[varanda]" id="varanda">
                                <label class="form-check-label checkboxes-label" for="varanda">Attached varanda</label>
                            </div>
                            <div class="form-check form-check-inline mx-3 pt-2">
                            ...
                            <div class="form-check form-check-inline mx-3 pt-2">
                                <input class="form-check-input" type="checkbox" name="filter[generator]" id="generator">
                                <label class="form-check-label checkboxes-label" for="generator">Generator</label>
                            </div>
                            <div class="form-check form-check-inline mx-3 pt-2">
                        ...
                        <div class="price-range-block mb-3">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                    ...
                                    <div class="d-flex  ">
                                        <input type="number" name="filter[room_size]" min=100 max="9900000" id="min_price" class="price-range-field form-control me-2" placeholder="Min-Size" />
                                        <input type="number" name="filter[room_size]" min=100 max="10000000" id="max_price" class="price-range-field form-control" placeholder="Max-Size" />
                                    </div>
                                </div>
                            </div>
                        </div>
