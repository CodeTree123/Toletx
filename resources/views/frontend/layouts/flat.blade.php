                        ...
                        <form class="form-horizontal top-form" action="{{route('flat_search')}}" role="form">
                            <div class="row   justify-content-between">
                                <div class="col-12  mt-2 top-from">
                                    <input type="text" name="filter[address]" class="form-control" id="flat_search_autocomplete" placeholder="Location" aria-label=" location">
                                </div>
                            ...
                            <div class="price-range-block mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div class="d-flex  ">
                                            <input type="number" name="filter[flat_size]" min=100 max="9900000" id="min_price" class="price-range-field form-control me-2" placeholder="Min-Size" />
                                            <input type="number" name="filter[flat_size]" min=100 max="10000000" id="max_price" class="price-range-field form-control" placeholder="Max-Size" />
                                        </div>
                                    </div>
                                </div>
                            </div>
