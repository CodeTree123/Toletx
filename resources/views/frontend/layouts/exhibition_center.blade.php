...
@section('content')
<title>ToletX-Exhibition Center</title>
<!-- Header Start -->
<header>
    <div class="container-fluid">
        <div class="col-md-12 mx-4">
            <div class="row  ">
                <a class="col-md-2 col-small mx-2 main-service text-center single_box" href="{{route('exhibition_center')}}">
            ...
            <div class="row">
                <form class="form-horizontal top-form" action="{{route('exibution_search')}}" method="get" role="form">
                    <div class="row  justify-content-between">
                        <div class="col-12 mt-2 top-from">
                            <input type="text" name="filter[address]" class="form-control" id="exhibition_search_autocomplete" placeholder="Location" aria-label=" location">
                        </div>
                    ...
                    <div class="my-4 ">
                        ...
                        <div class="form-check form-check-inline mx-3 pt-2">
                            <input class="form-check-input" type="checkbox" name="filter[fire_exit]" id="fire_exit">
                            <label class="form-check-label checkboxes-label" for="fire_exit">Fire Exit</label>
                        </div>
