...
<header class="mt-4">
    <div class="container-fluid">
        ...
        <div class="row row1">
            <div class="col-md-12">
                <div class="row  ">
                    <a class="col-md-2 col-small mx-2 main-service text-center single_box" href="{{route('shop')}}">
                ...
                <div class="row ml-1 mr-4 ">
                    <div class="container container-fluid">
                        <form class="form-horizontal top-form" action="{{route('shop_search')}}" method="get" role="form">
                            <div class="row   justify-content-between">
                                <div class="col-12 mt-2 top-from">
                                    <input type="text" name="filter[address]" class="form-control" id="shop_search_autocomplete" placeholder="Location" aria-label=" location">
                                </div>
                            ...
                            <div class="my-4 ">
                                ...
                                <div class="form-check form-check-inline mx-3 pt-2">
                                    <input class="form-check-input" type="checkbox" name="filter[fire_exit]" id="fire">
