...
<header class="mt-4">
    <div class="container-fluid">
        ...
        <div class="row row1">
            <div class="col-md-12">
                <div class="row  ">
                    <div class="col-md-2 col-small mx-2 main-service text-center single_box" href="{{route('hostel')}}">
                        ...
                        <form class="form-horizontal top-form" action="{{route('hostel_search')}}" role="form">
                            <div class="row  justify-content-between ">
                                <div class="col-12 mt-2 top-from">
                                    <input type="text" name="filter[address]" class="form-control" id="hostel_search_autocomplete" placeholder="Location" aria-label=" location">
                                </div>
