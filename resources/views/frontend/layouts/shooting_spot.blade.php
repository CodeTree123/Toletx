                        ...
                        <form class="form-horizontal top-form" action="{{route('shootingspot_search')}}" method="get" role="form">
                            <div class="row   justify-content-between">
                                <div class="col-12 mt-2 top-from">
                                    <input type="text" name="filter[address]" class="form-control" id="shooting_search_autocomplete" placeholder="Location" aria-label=" location">
                                </div>
                            ...
                            <div class="my-4 ">
                                ...
                                <div class="form-check form-check-inline mx-3 pt-2">
                                    <input class="form-check-input" type="checkbox" name="filter[dining]" id="wifi">
