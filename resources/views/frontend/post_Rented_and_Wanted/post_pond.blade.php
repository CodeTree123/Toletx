            ...
            <form method="POST" action="{{ route('post_pond_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="pond_area" type="number" class="form-control" id="area_Rent" placeholder="Enter Pond area" required>
                    </div>
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        <label for="height_Rent" class="form-label me-2 fw-bold">Water Level</label>
                        <input name="water_level" type="number" class="form-control" id="height_Rent" placeholder="Enter Water Level" required>
                    </div>
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                    ...
                    <div class="col-12 mb-3 ">
                        ...
                        <input name="address" type="text" class="form-control" id="pond_search_autocomplete" placeholder="Enter Address" required>
                    </div>
                    <div class="col-12 mb-3 ">
            ...
            <form method="POST" action="{{ route('post_pond_wanted') }}">
                ...
                <div class="col-12 mb-3 ">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="pond_area" type="number" class="form-control" id="area_Want" placeholder="Enter Pond area" required>
                    </div>
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        <label for="height_Want" class="form-label me-2 fw-bold">Water Level</label>
                        <input name="water_level" type="number" class="form-control" id="height_Want" placeholder="Enter Water Level" required>
                    </div>
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
