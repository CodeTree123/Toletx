            ...
            <form method="POST" action="{{ route('post_shooting_rented') }}" enctype="multipart/form-data">
                ...
                <div class=" col-12 mb-3 ">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="floor_area" type="text" class="form-control" id="floor_size_Rent" placeholder="Enter Spot Area" required>
                    </div>
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                    ...
                    <div class="col-12 mb-3 ">
                        ...
                        <input name="address" type="text" class="form-control" id="shoot_search_autocomplete" placeholder="Enter Address" required>
                    </div>
                    <div class="col-12 mb-3 ">
            ...
            <form method="POST" action="{{ route('post_shooting_wanted') }}">
                ...
                <div class=" col-12 mb-3 ">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="floor_area" type="text" class="form-control" id="floor_size_Want" placeholder="Enter Spot Area" required>
                    </div>
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
