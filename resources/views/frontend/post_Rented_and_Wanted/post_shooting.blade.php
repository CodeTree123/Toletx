            ...
            <form method="POST" action="{{ route('post_shooting_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <input name="c_name" type="text" class="form-control" id="title_Rent" placeholder="Enter Shooting Spot Name" value="{{old('c_name')}}">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="floor_area" type="text" class="form-control" id="floor_size_Rent" placeholder="Enter Shooting Spot Area" value="{{old('floor_area')}}">
            ...
            <form method="POST" action="{{ route('post_shooting_wanted') }}">
                ...
                <div class="row">
                    <div class=" col-12 mb-3 ">
                        ...
                        <input name="w_title" type="text" class="form-control" id="post_title_Want" placeholder="Enter Post Title" value="{{old('w_title')}}">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <input name="w_c_name" type="text" class="form-control" id="title_Want" placeholder="Enter Shooting Spot Name" value="{{old('w_c_name')}}">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="w_floor_area" type="text" class="form-control" id="floor_size_Want" placeholder="Enter Shooting Spot Area" value="{{old('w_floor_area')}}">
