                            ...
                            <div class="col-7 ps-0">
                                <div class="input-group">
                                    <select class="form-select form-select-md" aria-label=".form-select-lg example" id="s_per_price_rented" name="s_per_price">
                                        ...
                                        <option value="day shift" @selected(old('s_per_price')=="day shift" )> Day Shift</option>
                                        <option value="night shift" @selected(old('s_per_price')=="night shift" )> Night Shift</option>
                                        <option value="full day" @selected(old('s_per_price')=="full day" )> Full Day</option>
                                    </select>
                                </div>
                            </div>
                        </div>
            ...
            <form method="POST" action="{{ route('post_community_wanted') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="w_c_name" type="text" class="form-control" id="community_name_wanted" placeholder="Enter Community Hall Name" value="{{old('w_c_name')}}">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <p class="text-danger mb-0">@error('w_price') {{$message}} @enderror</p><br>
                            ...
                            <div class="col-7 ps-0">
                                <div class="input-group">
                                    <select class="form-select form-select-md" aria-label=".form-select-lg example" id="s_per_price_wanted" name="w_s_per_price">
                                        ...
                                        <option value="day shift" @selected(old('w_s_per_price')=="day shift" )> Day Shift</option>
                                        <option value="night shift" @selected(old('w_s_per_price')=="night shift" )> Night Shift</option>
                                        <option value="full day" @selected(old('w_s_per_price')=="full day" )> Full Day</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="w_seat" type="text" class="form-control" id="Seating_wanted" placeholder="Enter No of Seating Arrangement" value="{{old('w_seat')}}">
                        <span class="text-danger">@error('w_seat') {{$message}} @enderror</span>
                    </div>
                    <div class="col-12 mb-3 ">
