            ...
            <form method="POST" action="{{ route('post_exibution_center_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <input name="c_name" type="text" class="form-control" id="c_name_rented" placeholder="Enter Warehouse Name" required>
                    </div>
                    <div class=" col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
            ...
            <form method="POST" action="{{ route('post_exibution_center_wanted') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <input name="c_name" type="text" class="form-control" id="c_name_wanted" placeholder="Enter Warehouse Name" required>
                    </div>
                    <div class=" col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
