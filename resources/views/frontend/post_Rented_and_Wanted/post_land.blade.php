            ...
            <form method="POST" action="{{ route('post_land_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="land_area" type="text" class="form-control" id="area_Rent" placeholder="Enter area" required>
                    </div>
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        <label for="height_Rent" class="form-label me-2 fw-bold">Land Height</label>
                        <input name="land_height" type="text" class="form-control" id="height_Rent" placeholder="Enter Height" required>
                    </div>
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
            ...
            <form method="POST" action="{{ route('post_land_wanted') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="land_area" type="text" class="form-control" id="area_Want" placeholder="Enter area" required>
                    </div>
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        <label for="height_Want" class="form-label me-2 fw-bold">Land Height</label>
                        <input name="land_height" type="text" class="form-control" id="height_Want" placeholder="Enter Height" required>
                    </div>
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
