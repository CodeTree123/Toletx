            ...
            <form method="POST" action="{{ route('post_warehouse_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="floor_size" type="text" class="form-control" id="floor_size_Rent" placeholder="Enter Floor Area" required>
                    </div>
            ...
            <form method="POST" action="{{ route('post_warehouse_wanted') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="floor_size" type="text" class="form-control" id="floor_size_Want" placeholder="Enter Floor Area" required>
                    </div>
                    ...
                    <div class="col-12 mb-3 ">
                        ...
                        <div class="row ms-3 ps-2">
                            ...
                            <div class="col-2 form-check mb-2">
                                <input class="form-check-input" type="checkbox" id="drainage_system_Want" name="drainage_system">
