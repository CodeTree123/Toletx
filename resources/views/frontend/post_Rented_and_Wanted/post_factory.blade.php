            ...
            <form method="POST" action="{{ route('post_factory_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="floor_height" type="number" class="form-control" id="height_rented" placeholder="Enter Floor Hieght"required>
                    </div>
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                    ...
                    <div class="col-12 mb-3 ">
                        ...
                        <input name="address" type="text" class="form-control" id="factory_search_autocomplete" placeholder="Enter Address"required>
                    </div>
                    <div class="col-12 mb-3 ">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <div class="form-check ms-5 mb-2">
                            <input class="form-check-input" type="checkbox" id="drain_rented" name="drainage_system">
            ...
            <form method="POST" action="{{ route('post_factory_wanted') }}">
                ...
                <div class="col-12 mb-3 ">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="floor_height" type="number" class="form-control" id="height_wanted" placeholder="Enter Floor Hieght"required>
                    </div>
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
