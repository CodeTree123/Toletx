            ...
            <form method="POST" action="{{ route('post_flat_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-4 pe-0">
                                <div class="input-group">
                                    <input name="price" type="number" class="form-control" id="price_rented" placeholder="Enter Rent">
                                </div>
                            </div>
                            <div class="col-1">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <input name="floor_level" type="number" class="form-control" id="floor_level_rented" placeholder="Enter Floor Level">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <input name="bedrooms" type="number" class="form-control" id="bedroom_rented" placeholder="Enter Bedrooms">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <input name="drawing" type="number" class="form-control" id="Drawing_rented" placeholder="Enter Drawing rooms">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <input name="kitchen" type="number" class="form-control" id="Kitchen_rented" placeholder="Enter Kitchen rooms">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <input name="varanda" type="number" class="form-control" id="flat_varanda_rented" placeholder="Enter No. of veranda">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <input name="attached_toilet" type="number" class="form-control" id="flat_attached_toilet_rented" placeholder="Enter No. of toilets">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <input name="flat_size" type="text" class="form-control" id="flat_size_rented" placeholder="Enter Flat Size">
            ...
            <form method="POST" action="{{ route('post_flat_wanted') }}">
                ...
                <div class="row">
                    <div class="col-12 mb-3 ">
                        ...
                        <input name="w_title" type="text" class="form-control" id="room_name_wanted" placeholder="Enter Post Title ">
                        <span class="text-danger">@error('w_title') {{$message}} @enderror</span>
                    </div>
                    <div class=" col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        <label for="date_wanted" class="form-label me-2 fw-bold">Date</label>
                        <input name="w_date" type="date" class="form-control" id="date_wanted" min="{{\Carbon\Carbon::today()->format('Y-m-d')}}" onfocus="this.showPicker()">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <div class="row">
                            <div class="col-4 pe-0">
                                <div class="input-group">
                                    <input name="w_s_charge" type="number" class="form-control" id="s_charge_wanted" placeholder="Enter Service Charge">
                                </div>
                            </div>
                            <div class="col-1">
                                <span class="text-light fs-3">/</span>
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <input name="w_floor_level" type="number" class="form-control" id="floor_level_wanted" placeholder="Enter Floor Level">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <input name="w_bedrooms" type="number" class="form-control" id="bedroom_wanted" placeholder="Enter No. of Bedrooms">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <input name="w_drawing" type="number" class="form-control" id="Drawing_wanted" placeholder="Enter Drawing rooms">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <input name="w_dining" type="number" class="form-control" id="Dining_wanted" placeholder="Enter Dining rooms">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <input name="w_kitchen" type="number" class="form-control" id="flat_Kitchen_wanted" placeholder="Enter Kitchen rooms">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <input name="w_varanda" type="number" class="form-control" id="flat_varanda_wanted" placeholder="Enter No. of veranda">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <input name="w_attached_toilet" type="number" class="form-control" id="flat_attached_toilet_wanted" placeholder="Enter No. of toilets">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <input name="w_flat_size" type="text" class="form-control" id="flat_size_wanted" placeholder="Enter Flat Size">
                    ...
                    <div class="col-12 mb-3 ">
                        ...
                        <div class="row ms-3 ps-2">
                            <div class="col-2 form-check mb-2">
                                <input class="form-check-input" type="checkbox" id="electricity_wanted" name="w_electricity">
                            ...
                            <div class="col-2 form-check mb-2">
                                <input class="form-check-input" type="checkbox" id="cabel_tv_wanted" name="w_cable_tv">
