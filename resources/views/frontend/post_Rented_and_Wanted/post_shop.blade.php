            ...
            <form method="POST" action="{{ route('post_shop_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="price" type="number" class="form-control" id="price_Rent" placeholder="Enter Price" value="{{old('price')}}">
                        <span class="text-danger">@error('price') {{$message}} @enderror</span>
                    </div>
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        <label for="area_Rent" class="form-label me-2 fw-bold">Shop Area</label>
                        <input name="floor_size" type="text" class="form-control" id="area_Rent" placeholder="Enter Shop Area" value="{{old('floor_size')}}">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <select id="floor_Rent" class="form-select" name="floor_level" value="{{old('floor_level')}}">
                    ...
                    <div class="col-12 mb-3 ">
                        ...
                        <input name="address" type="text" class="form-control" id="shop_search_autocomplete" placeholder="Enter Address" value="{{old('address')}}">
            ...
            <form method="POST" action="{{ route('post_shop_wanted') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="w_floor_size" type="text" class="form-control" id="area_Want" placeholder="Enter Shop Area" value="{{old('w_floor_size')}}">
                    ...
                    <div class="col-12 mb-3 ">
                        ...
                        <input name="w_address" type="text" class="form-control" id="shop_search_autocomplete" placeholder="Enter Address" value="{{old('w_address')}}">
