            ...
            <form method="POST" action="{{ route('post_shop_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="floor_size" type="text" class="form-control" id="area_Rent" placeholder="Enter Shop Area" required>
                    </div>
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
            ...
            <form method="POST" action="{{ route('post_shop_wanted') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="floor_size" type="text" class="form-control" id="area_Want" placeholder="Enter Shop Area" required>
                    </div>
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
