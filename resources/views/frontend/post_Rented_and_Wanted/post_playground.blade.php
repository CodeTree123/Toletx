            ...
            <form method="POST" action="{{ route('post_playground_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="c_name" type="text" class="form-control" id="title_Rent" placeholder="Enter Camp Site Name" required>
                    </div>
                    <div class=" col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="area" type="text" class="form-control" id="area_Rent" placeholder="Enter Camp Site Area" required>
                    </div>
                    <div class="col-12 mb-3 ">
            ...
            <form method="POST" action="{{ route('post_playground_wanted') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="c_name" type="text" class="form-control" id="title_Want" placeholder="Enter Camp Site Name" required>
                    </div>
                    <div class=" col-lg-4 co-md-4 col-sm-12 col-12 mb-3">
                    ...
                    <div class="col-lg-4 co-md-4 col-sm-12 col-12 mb-3 ">
                        ...
                        <input name="area" type="text" class="form-control" id="area_Want" placeholder="Enter Camp Site Area" required>
                    </div>
                    <div class="col-12 mb-3 ">
