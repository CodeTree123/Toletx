...
<div class="row">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-12 product-div-right">
            <div>
                ...
                <div class=" ">
                    <span> <strong>Flat Size : </strong>{{$list->flat_size}}</span>
                </div>
                <div class=" ">
                    <span> <strong>Floor Level : </strong>{{$list->floor_level}}</span>
                </div>
                <div class=" ">
                    <span> <strong>No. of Bedroom's : </strong>{{$list->bedrooms}}</span>
                </div>
                <div class=" ">
                    <span> <strong>No. of Drawing Room : </strong>{{$list->drawing}}</span>
                </div>
                <div class=" ">
                    <span> <strong>No. of Dining Room : </strong>{{$list->dining}}</span>
                </div>
                <div class=" ">
                    <span> <strong>No. of Kitchen : </strong>{{$list->kitchen}}</span>
                </div>
                <div class=" ">
                    <span> <strong>No. of Toilets : </strong>{{$list->attached_toilet}}</span>
                </div>
                <div class=" ">
        ...
        <button type="button" class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target="#call">
            ...
            <!-- <div class="btn-groups d-flex flex-lg-row flex-md-row flex-sm-column flex-column">
                <a type="button" class="btn btn-primary text-white rounded-pill  me-2 mt-2">
...
<div class="row">
        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
            <div class="slider-for d1">
                @if($list->photo == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/flats/'.$list->photo)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/flats/'.$list->photo)}}" alt="">
                </a>
                @endif
                @if($list->photo1 == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/flats/'.$list->photo1)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/flats/'.$list->photo1)}}" alt="">
                </a>
                @endif
                @if($list->photo2 == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/flats/'.$list->photo2)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/flats/'.$list->photo2)}}" alt="">
                </a>
                @endif
                @if($list->photo3 == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/flats/'.$list->photo3)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/flats/'.$list->photo3)}}" alt="">
                </a>
                @endif
                @if($list->photo4 == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/flats/'.$list->photo4)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/flats/'.$list->photo4)}}" alt="">
                </a>
                @endif
                @if($list->photo5 == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/flats/'.$list->photo5)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/flats/'.$list->photo5)}}" alt="">
                </a>
                @endif
                @if($list->photo6 == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/flats/'.$list->photo6)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/flats/'.$list->photo6)}}" alt="">
                </a>
                @endif
            </div>
            <div class="container">
