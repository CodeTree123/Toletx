...
@if($list->post_type == 'Want')
    ...
    <div class="row">
        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
            <div class="slider-for d1">
                @if($list->photo != null)
                <a data-fancybox="gallery" href="{{asset('public/uploads/hotels/'.$list->photo)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/hotels/'.$list->photo)}}" alt="">
                </a>
                @endif
                @if($list->photo1 != null)
                <a data-fancybox="gallery" href="{{asset('public/uploads/hotels/'.$list->photo1)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/hotels/'.$list->photo1)}}" alt="">
                </a>
                @endif
                @if($list->photo2 != null)
                <a data-fancybox="gallery" href="{{asset('public/uploads/hotels/'.$list->photo2)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/hotels/'.$list->photo2)}}" alt="">
                </a>
                @endif
                @if($list->photo3 != null)
                <a data-fancybox="gallery" href="{{asset('public/uploads/hotels/'.$list->photo3)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/hotels/'.$list->photo3)}}" alt="">
                </a>
                @endif
                @if($list->photo4 != null)
                <a data-fancybox="gallery" href="{{asset('public/uploads/hotels/'.$list->photo4)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/hotels/'.$list->photo4)}}" alt="">
                </a>
                @endif
                @if($list->photo5 != null)
                <a data-fancybox="gallery" href="{{asset('public/uploads/hotels/'.$list->photo5)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/hotels/'.$list->photo5)}}" alt="">
                </a>
                @endif
                @if($list->photo6 != null)
                <a data-fancybox="gallery" href="{{asset('public/uploads/hotels/'.$list->photo6)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/hotels/'.$list->photo6)}}" alt="">
                </a>
                @endif
            </div>
            <div class="container">
