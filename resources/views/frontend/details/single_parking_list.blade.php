    ...
    <div class="row">
        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
            <div class="slider-for d1">
                @if($list->photo == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/garages/'.$list->photo)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/garages/'.$list->photo)}}" alt="">
                </a>
                @endif
                @if($list->photo1 == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/garages/'.$list->photo1)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/garages/'.$list->photo1)}}" alt="">
                </a>
                @endif
                @if($list->photo2 == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/garages/'.$list->photo2)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/garages/'.$list->photo2)}}" alt="">
                </a>
                @endif
                @if($list->photo3 == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/garages/'.$list->photo3)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/garages/'.$list->photo3)}}" alt="">
                </a>
                @endif
                @if($list->photo4 == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/garages/'.$list->photo4)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/garages/'.$list->photo4)}}" alt="">
                </a>
                @endif
                @if($list->photo5 == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/garages/'.$list->photo5)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/garages/'.$list->photo5)}}" alt="">
                </a>
                @endif
                @if($list->photo6 == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/garages/'.$list->photo6)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/garages/'.$list->photo6)}}" alt="">
                </a>
                @endif
            </div>
            <div class="container">
