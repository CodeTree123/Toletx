    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-12 product-div-right">
            <div>
                ...
                <div class=" ">
                    <span> <strong>Roof Area : </strong>{{$list->floor_area}}</span>
                </div>
                <div class=" ">
    ...
    <div class="row">
        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
            <div class="slider-for d1">
                @if($list->photo == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/rooftops/'.$list->photo)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/rooftops/'.$list->photo)}}" alt="">
                </a>
                @endif
                @if($list->photo1 == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/rooftops/'.$list->photo1)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/rooftops/'.$list->photo1)}}" alt="">
                </a>
                @endif
                @if($list->photo2 == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/rooftops/'.$list->photo2)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/rooftops/'.$list->photo2)}}" alt="">
                </a>
                @endif
                @if($list->photo3 == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/rooftops/'.$list->photo3)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/rooftops/'.$list->photo3)}}" alt="">
                </a>
                @endif
                @if($list->photo4 == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/rooftops/'.$list->photo4)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/rooftops/'.$list->photo4)}}" alt="">
                </a>
                @endif
                @if($list->photo5 == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/rooftops/'.$list->photo5)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/rooftops/'.$list->photo5)}}" alt="">
                </a>
                @endif
                @if($list->photo6 == null)
                @else
                <a data-fancybox="gallery" href="{{asset('public/uploads/rooftops/'.$list->photo6)}}">
                    <img class="img-fluid" src="{{asset('public/uploads/rooftops/'.$list->photo6)}}" alt="">
                </a>
                @endif
            </div>
            <div class="container">
