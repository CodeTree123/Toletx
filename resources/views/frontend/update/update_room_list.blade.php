                        ...
                        <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    @else
                                    <img src="{{asset('public/uploads/rooms/'.$list->photo)}}" alt="" srcset=""  class="update_section_image img-fluid img-fluid">

                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="input-group mt-2 update_section_file_input">
                                            <input type="file" class="form-control" name="photo" id="photo_Rent" placeholder="asd" onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])">
                                        </div>
                                        <!-- <a href="{{route('image_delete',['Room',$list->id,'rooms','photo',$list->photo])}}" class="btn btn-primary update_section_file_input_dlt_btn ms-1 p-2 ms-1 p-2">
                            ...
                            <div class="row">
                                ...
                                @if($list->photo1 == '')
                                    ...
                                    @else
                                    <img src="{{asset('public/uploads/rooms/'.$list->photo1)}}" alt="" srcset="" class="update_section_image img-fluid img-fluid">

                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="input-group mt-2 update_section_file_input">
                                            <input type="file" class="form-control" name="photo1" id="photo_Rent" placeholder="asd" onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])">
                                        </div>  
                                        <a href="{{route('image_delete',['Room',$list->id,'rooms','photo1',$list->photo1])}}" class="btn btn-primary update_section_file_input_dlt_btn ms-1 p-2 ms-1 p-2"><i class="fa-solid fa-trash-can"></i></a>
                                    </div>
                                ...
                                @if($list->photo2 == '')
                                    ...
                                    @else
                                    <img src="{{asset('public/uploads/rooms/'.$list->photo2)}}" alt="" srcset="" class="update_section_image img-fluid img-fluid">

                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="input-group mt-2 update_section_file_input">
                                            <input type="file" class="form-control" name="photo2" id="photo_Rent" placeholder="asd" onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])">
                                        </div>
                                        <a href="{{route('image_delete',['Room',$list->id,'rooms','photo2',$list->photo2])}}" class="btn btn-primary update_section_file_input_dlt_btn ms-1 p-2 ms-1 p-2"><i class="fa-solid fa-trash-can"></i></a>
                                    </div>
                                ...
                                @if($list->photo3 == '')
                                    ...
                                    @else
                                    <img src="{{asset('public/uploads/rooms/'.$list->photo3)}}" alt="" srcset="" class="update_section_image img-fluid img-fluid">
                                   <div class="d-flex justify-content-between align-items-center">
                                   <div class="input-group mt-2 update_section_file_input">
                                        <input type="file" class="form-control" name="photo3" id="photo_Rent" placeholder="asd" onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])">
                                    </div>
                                    <a href="{{route('image_delete',['Room',$list->id,'rooms','photo3',$list->photo3])}}" class="btn btn-primary update_section_file_input_dlt_btn ms-1 p-2 ms-1 p-2"><i class="fa-solid fa-trash-can"></i></a>
                                   </div>
                                    @endif
                                ...
                                @if($list->photo4 == '')
                                    ...
                                    @else
                                    <img src="{{asset('public/uploads/rooms/'.$list->photo4)}}" alt="" srcset="" class="update_section_image img-fluid img-fluid">
                                    <div class="d-flex justify-content-between align-items-center">
                                    <div class="input-group mt-2 update_section_file_input">
                                        <input type="file" class="form-control" name="photo4" id="photo_Rent" placeholder="asd" onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])">
                                    </div>
                                    <a href="{{route('image_delete',['Room',$list->id,'rooms','photo4',$list->photo4])}}" class="btn btn-primary update_section_file_input_dlt_btn ms-1 p-2 ms-1 p-2"><i class="fa-solid fa-trash-can"></i></a>
                                    </div>
                                    @endif
                                ...
                                @if($list->photo5 == '')
                                    ...
                                    @else
                                    <img src="{{asset('public/uploads/rooms/'.$list->photo5)}}" alt="" srcset="" class="update_section_image img-fluid img-fluid">
                                    
                                    <div class="d-flex justify-content-between align-items-center">
                                    <div class="input-group mt-2 update_section_file_input">
                                        <input type="file" class="form-control" name="photo5" id="photo_Rent" placeholder="asd" onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])">
                                    </div>
                                    <a href="{{route('image_delete',['Room',$list->id,'rooms','photo5',$list->photo5])}}" class="btn btn-primary update_section_file_input_dlt_btn ms-1 p-2 ms-1 p-2"><i class="fa-solid fa-trash-can"></i></a>
                                    </div>
                                ...
                                @if($list->photo6 == '')
                                    ...
                                    @else
                                    <img src="{{asset('public/uploads/rooms/'.$list->photo6)}}" alt="" srcset="" class="update_section_image img-fluid img-fluid">

                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="input-group mt-2 update_section_file_input">
                                            <input type="file" class="form-control" name="photo6" id="photo_Rent" placeholder="asd" onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])">
                                        </div>
                                        <a href="{{route('image_delete',['Room',$list->id,'rooms','photo6',$list->photo6])}}" class="btn btn-primary update_section_file_input_dlt_btn ms-1 p-2 ms-1 p-2"><i class="fa-solid fa-trash-can"></i></a>
                                    </div>
