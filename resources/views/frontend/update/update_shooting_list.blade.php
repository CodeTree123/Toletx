...
<div class=" col-12 mb-3 ">
                        ...
                        <div class=" col-lg-4 col-md-4 col-sm-12 col-12 mb-3 ">
                            ...
                            <input name="title" value="{{$list->title}}" type="text" class="form-control" id="title_Rent" placeholder="Enter Shooting Spot Name">
                        </div>
                        <div class=" col-lg-4 col-md-4 col-sm-12 col-12 mb-3">
...
<div class=" col-12 mb-3 ">
                        ...
                        <div class=" col-lg-4 col-md-4 col-sm-12 col-12 mb-3 ">
                            ...
                            <input name="title" value="{{$list->title}}" type="text" class="form-control" id="title_Want" placeholder="Enter Shooting Spot Name">
                        </div>
                        <div class=" col-lg-4 col-md-4 col-sm-12 col-12 mb-3">
