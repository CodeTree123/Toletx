                        ...
                        <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    @else
                                    <img src="{{asset('public/uploads/factories/'.$list->photo)}}" alt="" srcset=""  class="update_section_image img-fluid">
                                    <div class="d-flex justify-content-between">
                                        <div class="input-group mt-2 update_section_file_input">
                                            <input type="file" class="form-control" name="photo" id="photo_Rent" placeholder="asd" onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])">
                                        </div>
                                        <!-- <a href="{{route('image_delete',['Factory',$list->id,'factories','photo',$list->photo])}}" class="btn btn-primary update_section_file_input_dlt_btn ms-1 p-2"><i class="fa-solid fa-trash-can"></i></a> -->
                                    </div>
                                    @endif
                            ...
                            <div class="row">
                                ...
                                @if($list->photo1 == '')
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{route('image_delete',['Factory',$list->id,'factories','photo1',$list->photo1])}}" class="btn btn-primary update_section_file_input_dlt_btn ms-1 p-2"><i class="fa-solid fa-trash-can"></i></a>
                                    </div>
                                    @endif
                                ...
                                @if($list->photo2 == '')
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{route('image_delete',['Factory',$list->id,'factories','photo2',$list->photo2])}}" class="btn btn-primary update_section_file_input_dlt_btn ms-1 p-2"><i class="fa-solid fa-trash-can"></i></a>
                                    </div>
                                    @endif
                                ...
                                @if($list->photo3 == '')
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{route('image_delete',['Factory',$list->id,'factories','photo3',$list->photo3])}}" class="btn btn-primary update_section_file_input_dlt_btn ms-1 p-2"><i class="fa-solid fa-trash-can"></i></a>
                                    </div>
                                    @endif
                                ...
                                @if($list->photo4 == '')
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{route('image_delete',['Factory',$list->id,'factories','photo4',$list->photo4])}}" class="btn btn-primary update_section_file_input_dlt_btn ms-1 p-2"><i class="fa-solid fa-trash-can"></i></a>
                                    </div>
                                    @endif
                                ...
                                @if($list->photo5 == '')
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{route('image_delete',['Factory',$list->id,'factories','photo5',$list->photo5])}}" class="btn btn-primary update_section_file_input_dlt_btn ms-1 p-2"><i class="fa-solid fa-trash-can"></i></a>
                                    </div>
                                    @endif
                                ...
                                @if($list->photo6 == '')
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{route('image_delete',['Factory',$list->id,'factories','photo6',$list->photo6])}}" class="btn btn-primary update_section_file_input_dlt_btn ms-1 p-2"><i class="fa-solid fa-trash-can"></i></a>
                                    </div>
                                    @endif
