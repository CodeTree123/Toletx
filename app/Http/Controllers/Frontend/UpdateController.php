...
class UpdateController extends Controller
{
    ...
    function swimmingpool_update(Request $request, $id)
    {
        ...
        if ($swimmingpool->post_type == 'Rent') {
            $request->validate([
                'title' => 'required',
                'date' => 'required',
                'phone' => 'required',
    ...
    function exibution_center_update(Request $request, $id)
    {
        ...
        return back()->with('success', 'Exhibition Center information have been successfully Updated.');
    }
